//function printTable(){
   // $("#tablesdisplay").html(' <p id=\"table1\" style=\"display:block\" onmouseover=\"formTable(1)\">Table1</p> <p id=\"table2\" style=\"display:block\" onmouseover=\"formTable(2)\">Table2</p><p id=\"table3\" style=\"display:block\" onmouseover=\"formTable(3)\">Table3</p> <p><input type=\"text\" size=\"6\" id=\"mytext\" class=\"marleft\" style=\"display: block\" onfocusout=\"result()\"></p>');
